...
def plot_results(data, output_dir=None):
    ...
    if output_dir is None:
        output_dir = PROJECT_ROOT / "plots" / "linear_probe" / "not_detected_vs_detected_correct" / "layer_and_coeff_sweep"
...
if __name__ == "__main__":
    default_out = PROJECT_ROOT / "plots" / "linear_probe" / "not_detected_vs_detected_correct" / "layer_and_coeff_sweep"

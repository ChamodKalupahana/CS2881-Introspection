...
python test_probe_dir_casual_prompts_OOD.py --probe_path saved_activations/run_03_13_26_21_58/pca_components/last_token_layer_18_pca.pt --pca_index 2 --probe_layer 18 --layers 16 --coeffs 8.0 --datasets test_data --alphas -8 -5 0 2 5 8 16 --clean_once --prompts 2
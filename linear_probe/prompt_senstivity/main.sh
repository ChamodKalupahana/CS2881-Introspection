...
python test_probe_dir_casual_prompts_OOD.py --probe_path saved_activations/prompt_activations_03_10_26_19_27/pca_components/last_token_layer_21_pca.pt --pca_index 27 --probe_layer 21 --layers 16 --coeffs 8.0 --datasets test_data --alphas -8 -5 0 2 5 8 16 --clean_once --prompts 2
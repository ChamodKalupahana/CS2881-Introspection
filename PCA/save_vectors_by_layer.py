    ...
    for dataset_name in args.datasets:
        ...
        for layer in args.layers:
            ...
            for concept, (vec_last, vec_avg) in vectors.items():
                ...
                for coeff, skip_inject in tasks:
                    inject_label = "NO-INJECT" if skip_inject else f"coeff={coeff}"
                    ...
                    # New structure: run_X/{injected or not}/detected_{...}/{concept...}
                    ...
                    # User requested 'detected_{...}' but categories are already named like 'detected_correct' or 'not_detected'
                    # We will use the category name directly as it fits the pattern.
                    
                    out_dir = save_root / type_dir / category
                    out_dir.mkdir(parents=True, exist_ok=True)
                    
                    coeff_label = "noinject" if skip_inject else f"coeff{coeff}"
                    ...
                    for save_layer in layers_to_save:
                        ...
                        # Build path: out_dir / concept / filename.pt
